...
COLORS = {"wh": (30, 30, 30), "gr": (100, 100, 110), "fn": (90, 100, 90), "li": (255, 230, 190),
          ...
          'black': (10, 10, 10), 'orange': (180, 120, 40), 'dark_green': (20, 120, 60)}
...
def start_demo():
    ...
    tex_u = TextBox(sc, (220, 180, 200, 40), font, COLORS['black'], sub_moo=-1, text='u')
    inp_s = InputBox(sc, (10, 230, 200, 40), font, COLORS['lilac'], COLORS['yellow'], sub_moo=0)
    tex_s = TextBox(sc, (220, 230, 200, 40), font, COLORS['black'], sub_moo=0, text='s')
    inp_d = InputBox(sc, (10, 280, 200, 40), font, COLORS['lilac'], COLORS['yellow'], sub_moo=1)
    tex_d = TextBox(sc, (220, 280, 200, 40), font, COLORS['black'], sub_moo=1, text='d')
